...
## About The Project
3D tennis simulator built entirely in Godot. Two white blocks (representing players) play tennis against one another with hard-corded state-based logic.
...
- [x] Allow players to restart the rally on their own.
    ...
    - [ ] Add a scoring systemn, and track which player wins a point
